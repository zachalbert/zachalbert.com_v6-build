...
_All_ Designers are user experience designers, if you care to be pedantic with me for a moment. Since all designers work along the customer-facing spectrum, all designers have the capacity to affect the experience positively or negatively.
...
2. <a href="#what-kind-of-company-do-you-want-to-work-for">What kind of environment do you want to work in?</a>
...
Different stages of a company's lifecycle carries with it different perks, responsibilities, and downsides. The following generalizations are _almost_ too broad to be useful, so take this with a grain of salt.

* **Early Stage / Small Product Companies** _(Startups and companies usually with fewer than ~50 people)_ — Designers in these types of companies tend to need a more generalist skillset, a bouyant spirit, and a willingness to tackle new challenges for which they might be ill-equipped to handle.
  * *Good for:*
...
1. Decide if you want to <a href="#understanding-job-titles">specialize or generalize your skillset</a>
2. Decide <a href="#who-do-you-want-to-serve">who you care about working for</a>, and
3. Decide <a href="#what-kind-of-company-do-you-want-to-work-for">what kind of company you want to work in</a>

Finally, make sure to take advantage of <a href="https://news.layervault.com/">design</a> <a href="http://hunie.co/">communities</a> to ask for advice and critique as much as possible. This will minimize the time you spend bumbling around.
