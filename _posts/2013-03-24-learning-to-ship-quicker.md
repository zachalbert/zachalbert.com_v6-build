...
I knew that in order to implement this perspective shift, I needed to do something drastically different. Inspired by [Drew Wilson][4] and [Josh Long][5], who wrote [a book about rapid execution][6] in 8 days (naturally), I shifted into survival mode.<figure class="card wp-caption alignnoneid="attachment\_68" aria-labelledby="figcaption\_attachment_68">

<div class="mask" id="mask">
  <img class="size-full wp-image-68" alt="Execute Book" src="/images/execute.jpg" width="1000" height="667" />
</div><figcaption id="figcaption-attachment_68" class="wp-caption-text">

[Execute][6] by Drew Wilson and Josh Long</figcaption></figure> 
...
**<figure class="card wp-caption alignnoneid="attachment\_75" aria-labelledby="figcaption\_attachment_75">

<div class="mask" id="mask">
  <a href="/images/problems.jpg"><img class="size-full wp-image-75" alt="Not every problem needs to be solved today." src="/images/problems.jpg" width="1200" height="800" /></a>
</div><figcaption id="figcaption-attachment_75" class="wp-caption-text">Not every problem needs to be solved today.</figcaption></figure> 
...
> &#8220;Culture changes what it expects from design after design changes culture.&#8221;<cite>(<em>from </em><a href="http://www.shapeofdesignbook.com/chapter06.html">The Shape of Design, <em>chapter 6</em></a>).</cite>
...
I&#8217;m going to wrap this rambly post up with a brief case study on the decisions I made for this very site. I had two main outcomes: (1) to practice shipping before I&#8217;m completely comfortable, and (2) to make the lessons I learn publicly available, since reading [the accounts of others][11] is what inspired me.

  1. **“I haven&#8217;t finished my custom portfolio yet.”  
    **I decided that I didn&#8217;t need to launch with my portfolio. This was the hardest decision, because this site has traditionally *only* served as my online portfolio. But I do have [my Dribbble feed auto-blogging to my wordpress site][12], which completely *accomplishes the goal* of showing my work. When I refocused on outcomes, I realized how silly it was to hold up launch to do version 2.0 of a feature (when nobody has even seen version 1.0 yet).  
    **Lesson Learned**: *Don&#8217;t get attached to outputs, get attached to solving the problem at hand.*
  2. **“The footer sucks, and I don&#8217;t have a contact form”**  
    Re: the footer — who cares?  
    Re: contact form — how many people still use contact forms? I&#8217;ve placed prominent links to my various online profiles at the top of the page. These methods might not be quite as convenient, but they still allow communication to occur.  
    **Lesson Learned**: *Think in terms of short-term and long-term solutions. If a short-term solution allows you to ship sooner, then it&#8217;s probably worth it.*
  3. **“IT&#8217;S NOT COMPLETELY RESPONSIVE!!!1”**  
    This one always gives me a good chuckle. You wouldn&#8217;t believe the amount of time I wasted trying to design responsive hi-fi mockups in my drug of choice — Illustrator. It&#8217;s not that I don&#8217;t love RWD and think it&#8217;s fun, but I&#8217;m just one lonely perfectionist trying to launch a website with a few spare hours each week, and it was really getting in the way of shipping quickly. Plus, I can always add responsive support later. Sorry, mobilites.  
    **Lessons Learned**: *An unshipped product isn&#8217;t a product at all. A so-so experience is better than no experience.*
  4. **“The design is outdated and lacks polish”**  
    This is another tough one for me, as it&#8217;s an easy trap to fall into. This design already feels outdated to me because it&#8217;s been locked up in the lab for so long. Going back to point #1 — don&#8217;t get attached to outputs. My objectives are to practice shipping, and to share my learning — and the level of design polish isn&#8217;t standing in the way of that.  
    **Lesson Learned**: *Focus on what matters. Stay true to the outcomes you set out to achieve.*
